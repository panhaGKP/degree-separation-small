...
def person_id_for_name(name):
    ...
    """
    person_ids = list(names.get(name.lower(), set())) # get list of person and covert to set of person name
    if len(person_ids) == 0:
        return None
        ...
        return person_ids[0] # Return first person in set if there is no many
